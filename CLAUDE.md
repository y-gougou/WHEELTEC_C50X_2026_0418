...
2. **Current Sensing**: `current_reader.py` ← serial `/dev/ttyCH343USB1` → `/current_data`
...
|--------|--------------|-----------|---------|
| Base controller | `/dev/wheeltec_controller` | 115200 | Motor control, odometry, IMU |
| Current sensing | `/dev/ttyCH343USB1` | 115200 | Three-channel current reading |
